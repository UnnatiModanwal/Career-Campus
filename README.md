...
```bash
cd backend
python quick_test.py  # Quick API verification
python test_api.py    # Full API testing
```
...
**Unnati Modanwal**
- GitHub: [@UnnatiModanwal](https://github.com/UnnatiModanwal)
- LinkedIn: [Connect with me](https://linkedin.com/in/UnnatiModanwal)
...
1. Check the [Issues](https://github.com/UnnatiModanwal/Career-Campus/issues) page
2. Create a new issue with detailed description
3. Join our [Discussions](https://github.com/UnnatiModanwal/Career-Campus/discussions)
